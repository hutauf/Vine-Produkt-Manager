      ...
      try {
        ...
        if (Array.isArray(jsonData)) {
          jsonData.forEach((productData: any, index: number) => {
            ...
            const parsedTeilwert = parseNullableNumber(productData.teilwert);
            const parsedTeilwertV2 = parseNullableNumber(productData.teilwert_v2);
            ...
            products.push({
              ...
              teilwert: parsedTeilwert,
              teilwert_v2: parsedTeilwertV2,
              pdf: productData.pdf,
